...
public class EitherTest {
    ...
    void testFoldWithLogWithLeft() {
        ...
        Assertions.assertEquals("left: 42", result);
    }

    @Test
    void testFoldWithLogWithRight() {
        Either<Integer, String> either = Either.right("Hello");
        var result = either.fold(
                left -> "left: " + left,
                right -> "right: " + right,
        ...
        Assertions.assertEquals("right: Hello", result);
    }

    @Test
    void testFoldWithLogWithNullLeft() {
        Either<Integer, String> either = new Either.BaseMethods<>();
    ...
    @Test
    void testFoldWithLogWithNullRight() {
        Either<Integer, String> either = new Either.BaseMethods<>();
        Assertions.assertThrows(
                UnsupportedOperationException.class,
                () -> either.fold(
