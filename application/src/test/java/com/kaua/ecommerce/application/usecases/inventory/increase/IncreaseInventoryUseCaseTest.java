...
public class IncreaseInventoryUseCaseTest extends UseCaseTest {
    ...
    @InjectMocks
    private DefaultIncreaseInventoryQuantityUseCase increaseInventoryQuantityUseCase;

    @Test
    void givenAValidCommand_whenCallExecuteIncrease_thenShouldIncreaseInventoryQuantity() {
    ...
    @Test
    void givenAnInvalidSku_whenCallExecuteIncrease_shouldThrowNotFoundException() {
        final var aSku = "sku";
        final var aQuantity = 10;
        ...
        final var aOutput = Assertions.assertThrows(NotFoundException.class,
                () -> this.increaseInventoryQuantityUseCase.execute(aCommand));
    ...
    @Test
    void givenAnInvalidQuantity_whenCallExecuteIncrease_shouldReturnDomainException() {
        final var aInventory = Fixture.Inventories.tshirtInventory();
    ...
    @Test
    void givenAValidCommand_whenCallExecuteIncreaseButThrowsOnCreateInventoryMovement_thenShouldThrowTransactionFailureException() {
        final var aInventory = Fixture.Inventories.tshirtInventory();
