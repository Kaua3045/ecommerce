...
public interface ElasticsearchTestContainer {
    ...
    @Container
    ElasticsearchContainer ELASTIC = new EcommerceElasticsearchContainer();

    class EcommerceElasticsearchContainer extends ElasticsearchContainer {
        ...
        private static final String CLUSTER_NAME = "ecommerce";
        private static final String CLUSTER_USER = "elastic";
        private static final String CLUSTER_PWD = "elastic";

        public EcommerceElasticsearchContainer() {
            super(DockerImageName.parse(IMAGE).asCompatibleSubstituteFor(COMPATIBLE));
            this.addFixedExposedPort(9200, 9200);
            this.withLogConsumer(new Slf4jLogConsumer(LoggerFactory.getLogger(EcommerceElasticsearchContainer.class)));
